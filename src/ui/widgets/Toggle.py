...
class Toggle(QCheckBox):
    ...
    def __init__(self,
            parent=None,
            bar_color=Qt.gray,
            checked_color="#006ee6",
            handle_color=Qt.white,
            ):
        super().__init__(parent)
        super().setMaximumWidth(60)
...
class AnimatedToggle(Toggle):
    ...
    def __init__(self, *args, pulse_unchecked_color="#44999999",
                 pulse_checked_color="#44006ee6", **kwargs):
...
class SettingWidget(QWidget):
    ...
    def __init__(self, text) -> None:
        ...
        label = QLabel(f"<strong>{text}</strong>")
        self.toggle = AnimatedToggle()
        self.toggle.setContentsMargins(0, 0, 0, 0)
        ...
        self.toggle.stateChanged.connect(self.statechange)

    def statechange(self, i):
        self.stateChanged.emit(i)

    def setStatus(self, e):
        self.toggle.setChecked(e)
